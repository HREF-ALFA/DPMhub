...
if ($action == 'create')
{
    print_fiche_titre($langs->trans('Nuevo Trancito Internacional'));
    ...
    // Ref
    print '<tr><td class="fieldrequired">'.$langs->trans('Ref. de Trancito Internacional').'</td><td><input name="ref_supplier" value="'.(isset($_POST['ref_supplier'])?$_POST['ref_supplier']:$fac_ori->ref).'" type="text"></td>';

    // Third party
    print '<tr><td class="fieldrequired">'.$langs->trans('Ref. de Transportista').'</td><td><input name="ref_supplier" value="'.(isset($_POST['ref_supplier'])?$_POST['ref_supplier']:$fac_ori->ref).'" type="text"></td>';
    ...
    */
    //
    //$sql= 'SELECT * FROM `llx_transport(transporte)`';
    //$result=$db->query($sql);
    ...
    // Label
    print '<tr><td>'.$langs->trans('Numero de guia').'</td><td><input size="30" name="libelle" value="'.(isset($_POST['libelle'])?$_POST['libelle']:$fac_ori->libelle).'" type="text"></td></tr>';
    ...
    //Combo de medio de transporte
    print '<tr '.$bc[$var].'><td class="fieldrequired">'.$langs->trans("Frontera de destino").'</td><td>';
    print '<select name=trans>';
    print '<option value=tm>'."Transporte maritimo ocurre puerto".'</option>'; 
    print '<option value="ttd">'."Transporte terrestre directo".'</option>'; 
    print '<option value="ttc">'."Transporte terrestre carga consolidada".'</option>'; 
    print '<option value="ta">'."Transporte aereo ocurre aeropuerto".'</option>'; 
    print '</select></td></tr>';
    //Nota publica
