...
// Pestaña 1
$que.= "VALUES ('".$r_transito."', '".$r_transportista."','".$transportista."','".$auto_s."','".$fecha_e."','".$eta."','".$num_guia."','".$pais_o."','".$frontera."','".$notapu."','".$notapri."','".$numero."','".$medio_em."', '.3.') "; 
