 ...
 */
class modImportacion extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->rights_class = 'modImportacion';
		...
		$this->description = "Gestion de importacion";
        ...
        */
		...
		// Example to declare a new Top Menu entry and its Left menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>0,			                // Put 0 if this is a top menu
                        ...
                        'titre'=>'Importacion',
                        'mainmenu'=>'Importacion',
                        'leftmenu'=>'Importacion',
                        'url'=>'/importacion/index.php',
