...
if ($id > 0)
{
	...
	print '<tr><td width="30%">'.$langs->trans("Nombre del Acreedor").'</td><td width="70%" colspan="3">';
	...
	if ($object->client)
	{
		...
		print '<tr><td>';
		print $langs->trans('Codigo de Acreedor').'</td><td colspan="3">';
		...
		print '<tr>';
		print '<td>';
		print $form->editfieldkey("Codigo contable Acreedor",'customeraccountancycode',$object->code_compta,$object,$user->rights->societe->creer);
