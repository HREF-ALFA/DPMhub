...
if ($socid)
{
	...
	print '<tr><td width="25%">'.$langs->trans("Nombre del Acreedor").'</td><td colspan="3">';
	...
	{
		print '<tr><td>';
		print $langs->trans('Codigo Acreedor').'</td><td colspan="3">';
    ...
    print load_fiche_titre($langs->trans("Eventos respecto a este Acreedor"),'','');
